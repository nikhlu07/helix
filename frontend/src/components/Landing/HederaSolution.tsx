...
export function HederaSolution() {
    ...
    const howItWorks = [
        {
            step: '1',
            title: 'Register on Hedera',
            description: 'Manufacturers register each batch on Hedera, minting a unique digital twin for every item. A secure QR links the physical product to its immutable record.',
    ...
    const features = [
        {
            icon: Lock,
            title: 'Hashgraph Integrity',
            description: 'Built on Hedera Hashgraph for ABFT security and fair ordering—every event is tamper-evident and auditable.',
        },
        {
            icon: Eye,
        ...
        },
        {
            ...
            description: 'Metadata anchored to Hedera Consensus Service (HCS) to ensure permanence, resilience, and verifiable timestamps.',
        },
        {
            icon: Globe,
            ...
            <section id="features" className="py-20 lg:py-32 bg-white relative">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-lg text-gray-600">
                            An architecture that marries Hedera's assurances with modern cloud primitives—reliable, fast, and ready for scale.
                        </p>
                    </div>
